...
- Expanded ids inherit conservative bounds from every matching wildcard group. Tiered prices are retained only when all matching groups use compatible thresholds; otherwise tiers are omitted and any existing incomplete-metadata marker is preserved.
